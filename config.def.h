...
static const char *fonts[]          = { 
  "Deja Vu Sans Mono:style=book:size=10",
  "Symbola:pixelsize=10"
};
...
static Key keys[] = {
  ...
  { 0,                            XK_Print,  spawn,          {.v = prntselcmd } },
  { ShiftMask,                    XK_Print,  spawn,          {.v = prntallcmd } },
